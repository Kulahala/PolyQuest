...
- The approved leaf tags are `Ability.Attack.Light`, `Ability.Attack.Primary`, `Ability.Attack.Charged`, `Ability.Dodge`, `Data.Damage.Charged`, `Event.Attack.Light.Hit`, `Event.Attack.Light.Combo.InputWindow.Begin`, `Event.Attack.Light.Combo.InputWindow.End`, `Event.Attack.Light.Combo.BranchWindow.Begin`, `Event.Attack.Light.Combo.BranchWindow.End`, `Event.Attack.Charged.Hit`, `Event.Attack.Charged.HoldReady`, `Event.Attack.Charged.ReleaseHandoff`, `Event.Action.CancelWindow.Dodge.Begin`, `Event.Action.CancelWindow.Dodge.End`, `Event.Dodge.Invulnerability.Begin`, `Event.Dodge.Invulnerability.End`, `Event.Input.Canceled`, `Event.Input.Pressed`, `Event.Input.Released`, `Input.AbilitySlot.1` through `.4`, `Input.Aim`, `Input.Dodge`, `Input.PrimaryAttack`, `State.Action.Attacking`, `State.Action.CanCancel.Dodge`, `State.Action.Charging`, `State.Action.Dodging`, `State.Input.Block.Movement`, `State.Input.Block.Jump`, `State.Resource.Stamina.RegenBlocked`, `State.Status.Dead`, `State.Status.Exhausted`, `State.Status.Invulnerable`, and `State.Status.Stunned`.
...
- Sprint and Sprint Attack, player death, GameplayCues, generic hit-resolution, and nonlinear or multi-weapon combo-extension contracts.
