...
private:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Combat|Enemy|Reaction", meta = (AllowPrivateAccess = "true", ToolTip = "敌人受到轻击受击（Small Tier）时播放的叠加层受击动画 Montage 资产。"))
