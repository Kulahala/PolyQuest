...
- The product route is `/Game/Maps/Scene01` with a fixed elevated oblique camera and a desktop Controller/input boundary. `TODO-03A7B/C/D/F`, `TODO-03H5`, `TODO-03I1/I2`, `TODO-07B5/B6`, and `TODO-03I4` have implementation closeouts recorded in `ROADMAP-archive.md`; their individual authored/readback/compile debts remain in Known Risks. `TODO-03I4` has removed the zero-reference legacy Loadout C++/test surface: direct weapon fields, Defense Profile, prepared handles, and the existing equipment transaction are now the only combat-input/equipment contract. The next open planning slice is `TODO-07B7`; detailed stage records remain in `plan.md`.
...
- [ ] TODO-07B7: Combat Feedback Profile Taxonomy Split v1
  - Start before `TODO-05A`; `TODO-03I4` is complete. The current Player/Enemy profiles already demonstrate a real authoring problem because role-specific fields are mixed in one panel. This stage is not triggered merely by adding another enemy.
...
- [ ] TODO-07B: Feedback, Presentation Retune, And Demo Polish v1
  - TODO-07B1/07B1A, TODO-07B2, TODO-07B3, TODO-07B4, TODO-07B5, and TODO-07B6 are delivered; `TODO-03I4` has separately removed the legacy Loadout compatibility surface. TODO-07B7 is the accepted follow-up profile-taxonomy stage. The umbrella owns focused presentation work, not new combat ownership.
