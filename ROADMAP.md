...
Current implementation closeouts: TODO-03A7B (Light entry 0..2 lifecycle adoption) → TODO-03A7C (Charged/Sprint source adoption; authored compile/readback debt remains) → TODO-03A7D (Melee Skill source adoption; Whirlwind authored readback debt remains) → TODO-03A7F (explicit trigger-range contract; authored migration/readback debt remains) → TODO-03H5 (Review-Only health audit; no P0-P2 blocker) → TODO-03I1 (Primary/Sprint direct route and Loadout compatibility mirror; authored cleanup/readback debt remains) → TODO-03I2 (cross-weapon cancellation/tag taxonomy; Dodge E2E fixture debt remains) → TODO-07B5 (Small Hit Reaction retrigger; real ASC cross-frame fixture debt remains)
Next player-combat slices: TODO-07B6 → TODO-05A → TODO-05B → TODO-03C
...
- [ ] TODO-05A: Stagger Front Execution v1
  - Start after `TODO-07B5` and `TODO-07B6` close their focused reaction/feedback gates; this keeps the execution slice focused on target reservation, geometry, Montage, hit, and cleanup rather than absorbing basic combat presentation work.
...
- [ ] TODO-03C: Ranged Enemy v1
  - Add one StateTree-driven ranged enemy only after TODO-03A3E, TODO-07B4, TODO-03A7, TODO-03A7B, TODO-03A7C, TODO-03A7D, TODO-03A7F, TODO-03H5, TODO-03I1, TODO-03I2, TODO-07B5, TODO-07B6, TODO-05A, and TODO-05B each pass their own adoption, compile, Automation, Editor/PIE, and review gates (or a Motion-Warp slice closes with an evidence-backed no-adoption decision).
...
- [ ] TODO-07B: Feedback, Presentation Retune, And Demo Polish v1
  - TODO-07B1/07B1A, TODO-07B2, TODO-07B3, TODO-07B4, and TODO-07B5 are delivered. TODO-07B6 is the remaining explicitly scoped child before the first ranged enemy; the umbrella owns focused presentation work, not new combat ownership.
