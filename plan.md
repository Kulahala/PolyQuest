...
- Commit boundary (awaiting explicit approval): `Source/PolyQuest/Public/Character/Player/PlayerCharacter.h`, `Config/DefaultGame.ini`, `Config/Tags/PolyQuestGameplayTags.ini`, `README.md`, `ARCHITECTURE.md`, `ROADMAP.md`, `plan.md`. All `Content/**`, `PolyQuest.uproject` changes, generated directories, and unrelated user WIP stay excluded.
